...
but it should issue a warning (when [DEBUG](https://metacpan.org/pod/Archive::Ar::Libarchive#DEBUG) is turned on) under similar circumstances.
...
This also can take a second optional debugging parameter.  This acts exactly as if [DEBUG](https://metacpan.org/pod/Archive::Ar::Libarchive#DEBUG) is called on the object before it is returned.  If you have a [new](https://metacpan.org/pod/Archive::Ar::Libarchive#new) that keeps failing, this
should help.
...
it like an ar archive. Like [read](https://metacpan.org/pod/Archive::Ar::Libarchive#read), it will wipe out whatever you have in the
...
Due to the nature of the ar archive format, [add_files](https://metacpan.org/pod/Archive::Ar::Libarchive#add_files) will store
...
Takes an filename and a set of data to represent it. Unlike [add_files](https://metacpan.org/pod/Archive::Ar::Libarchive#add_files), [add_data](https://metacpan.org/pod/Archive::Ar::Libarchive#add_data)
...
the filename present if specified. If given a filename, [write](https://metacpan.org/pod/Archive::Ar::Libarchive#write) will
...
Sets the output format produced by [write](https://metacpan.org/pod/Archive::Ar::Libarchive#write) to use BSD format.
...
Sets the output format produced by [write](https://metacpan.org/pod/Archive::Ar::Libarchive#write) to System VR4 format.
Note: this method is not available in l<Archive::Ar>.
